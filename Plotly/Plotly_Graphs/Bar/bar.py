...
barchart = px.bar(
    ...
    # color_continuous_scale="Picnic",       # set marker colors. When color colum is numeric data
    # color_continuous_midpoint=1000,                           # set desired midpoint. When colors=diverging
