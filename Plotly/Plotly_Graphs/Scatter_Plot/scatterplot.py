...
scatterplot = px.scatter(
    ...
    color="tbl_size",                                              # differentiate markers by color
    ...
    #                     "Sat":"black","Sun":"brown"},
    # color_continuous_scale="Armyrose",      # set marker colors. When color colum is numeric data
...
# scatterplot.update_layout(legend={'x':0,'y':1.2})
