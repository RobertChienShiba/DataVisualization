...
violinfig = px.violin(
    ...
    color_discrete_map={"ALABAMA": "orange" ,"NEW YORK":"magenta"}, # map your chosen colors
...
# violinfig=go.Figure()
# violinfig.add_traces(go.Violin(x=df[df["State"]=="ALABAMA"]["Affected by"],
#                         y=df[df["State"]=="ALABAMA"]["Percent of Colonies Impacted"],
#                         side="negative",jitter=1,legendgroup='ALABAMA',scalegroup='ALABAMA',
#                         line_color="orange",points="all",name="ALABAMA"))
# violinfig.add_traces(go.Violin(x=df[df["State"]=="NEW YORK"]["Affected by"],
#                         y=df[df["State"]=="NEW YORK"]["Percent of Colonies Impacted"],
#                         side="positive",jitter=1,legendgroup='ALABAMA',scalegroup='ALABAMA',
#                         line_color="magenta",points="all",name="NEW YORK"))
